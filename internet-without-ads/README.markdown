...
**privacy-violating** experience that even the web’s creator regrets[^1] and the reason is a
monolithic business model that incentivizes these qualities.
...
of my apps** have gone on to hit **1 million active users**.[^3] Among them, **Disconnect** powers
built-in privacy features for users of Mozilla Firefox[^4], Samsung Internet[^5], and Microsoft
Edge[^6] and **Adblock Fast** is (as far as I can tell) the world’s third- or fourth-most popular ad
blocker, with more than 10 million users[^7].
...
From 1965 (the year after the Surgeon General linked cigarettes publicly to disease[^11]) through
2015, the tobacco industry ran **$254.1 billion of ads**[^12]<sup>, </sup>[^13] and caused **20.8
million attributable deaths**[^14] in just the United States.
...
cereal, snacks, and drinks[^15] (compared with $9.1 billion run by the tobacco industry[^12]<sup>,
</sup>[^13]). Obesity, meanwhile, is the leading preventable cause of death behind only tobacco use,
at **365 thousand attributable deaths** per year (to tobacco use’s 435 thousand deaths).[^16]
...
The largest ad network by market share, Google[^17], is able to collect **92% of web
searches**[^18], **34% of browsing history**[^19], **73% of app usage**[^20], and **72% of
geolocation requests**[^21]. Google transforms this data into **up to 34 demographic categories**
like whether or not you graduated from high school or have young children, **up to 154 affinity
categories** like whether or not you eat fast food or watch reality shows, and **up to 779 purchase
intents** like what clothes you’re shopping for or where you’re planning a trip to.[^22]
...
than 50 related projects**[^34]. An example is **Folding@home**, which simulates protein synthesis
...
**Coinhive** was[^39] a mysterious company[^40] that solved the chicken-and-egg problem with a
clever and likewise cryptocurrency-adjacent product, a miner miniaturized to execute in-browser (the
...
or paywall replacement and **up to 40 thousand publishers** did[^41].
...
(Salon was a rare exception[^42]). These sites were effectively engaged in drive-by mining, which
fueled a new malware classification called “cryptojacking”.
...
[^30]: <a href="https://www.developereconomics.com/blog/how-much-is-an-active-user-worth">How much
       is an active user worth<em>?</em></a>, SlashData
...
[^34]: [Project list](https://boinc.berkeley.edu/wiki/Project_list), Berkeley Open Infrastructure
